...
- It reports local Claude, Codex, Cursor, TokenRouter, OpenRouter, Pioneer, and Command Code quota windows, and it must never route, recommend, proxy, intercept, log in, import browser cookies, or mutate provider state.
