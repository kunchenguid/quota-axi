...
| Reports and details not cached         | Failed providers, stale providers, account identity, and source attempts are not cached; a snapshot keeps only a hashed subscription stamp (see [Same subscription across sources](#same-subscription-across-sources)). Claude native inference readings (`source: cli`) are excluded from both cache writes and clears, leaving existing stored-session snapshots untouched.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
