...
| Auth source names    | `oauth-file`, `keychain`, `auth-json`, `auth-env`, `apps-json`, `state-vscdb`, `cli-rpc`, `pi:openai-codex`, `pi:kimi-coding`, `pi:xai`, and `kimi-code-cli` |
