...
export const SKILL_DESCRIPTION =
  "Report local Claude, Codex, Cursor, GitHub Copilot, Grok, Kimi, Muse Code, Z.AI, Alibaba, OpenCode Go, Ollama Cloud, Antigravity, Command Code, MiniMax, MiMo, DeepSeek, OpenRouter, ElevenLabs, and Devin quota windows via the quota-axi CLI - remaining " +
