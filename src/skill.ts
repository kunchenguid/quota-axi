...
export const SKILL_DESCRIPTION =
  "Report local Claude, Codex, Cursor, GitHub Copilot, Grok, Kimi, Meta Muse Spark, Z.AI, Alibaba, OpenCode Go, Antigravity, and Command Code quota windows via the quota-axi CLI - remaining " +
  ...
  "with no routing, no credential persistence, and no default ordering preference. Use before deciding whether it is safe " +
